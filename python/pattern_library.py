...
class PatternLibrary:
    ...
    def _load_default_patterns(self):
        ...
        self.add_pattern(FraudPattern(
            id="rapid_transactions",
            name="Rapid Transactions",
            description="Multiple transactions in a short time window",
            rules=[
                Rule("transaction_count", Operator.GREATER_THAN, 10,
                     "More than 10 transactions"),
                Rule("time_window_seconds", Operator.LESS_THAN, 60,
                     "Within 60 seconds")
            ],
        ...
        self.add_pattern(FraudPattern(
            ...
            rules=[
                Rule("path_length", Operator.GREATER_THAN, 3,
                     "Transaction path longer than 3 hops"),
                Rule("returns_to_source", Operator.EQUALS, True,
        ...
        self.add_pattern(FraudPattern(
            ...
            rules=[
                Rule("amount_deviation", Operator.GREATER_THAN, 3.0,
        ...
        self.add_pattern(FraudPattern(
            ...
            rules=[
                Rule("distance_from_usual_km", Operator.GREATER_THAN, 1000,
                     "More than 1000km from usual location"),
                Rule("time_since_last_transaction_hours", Operator.LESS_THAN, 2,
        ...
        self.add_pattern(FraudPattern(
            ...
            rules=[
                Rule("transaction_count", Operator.GREATER_THAN, 5,
                     "More than 5 transactions"),
                Rule("all_below_threshold", Operator.EQUALS, True,
                     "All amounts just below $10,000"),
                Rule("time_window_hours", Operator.LESS_THAN, 24,
                     "Within 24 hours")
            ],
            severity=Severity.CRITICAL,
            category="money_laundering"
        ...
        self.add_pattern(FraudPattern(
            ...
            rules=[
                Rule("failed_login_attempts", Operator.GREATER_THAN, 5,
                     "More than 5 failed logins"),
                Rule("new_device", Operator.EQUALS, True,
                     "Login from new device"),
                Rule("new_location", Operator.EQUALS, True,
        ...
        self.add_pattern(FraudPattern(
            ...
            rules=[
                Rule("rapid_in_out", Operator.EQUALS, True,
                     "Money received and sent out quickly"),
                Rule("account_age_days", Operator.LESS_THAN, 30,
                     "New account (less than 30 days)"),
                Rule("transaction_volume", Operator.GREATER_THAN, 50000,
        ...
        self.add_pattern(FraudPattern(
            ...
            rules=[
                Rule("identity_verification_score", Operator.LESS_THAN, 0.5,
                     "Low identity verification score"),
                Rule("inconsistent_data", Operator.EQUALS, True,
                     "Inconsistent personal information"),
                Rule("recent_account_creation", Operator.EQUALS, True,
