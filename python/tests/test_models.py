...
class TestAnalyzeResponse:
    ...
    def test_optional_reason(self):
        ...
        response = AnalyzeResponse(
            user_id=50, score="0.123", is_fraud=False, agent_report="Normal behavior"
        )
...
class TestErrorResponse:
    ...
    def test_error_response(self):
        ...
        error = ErrorResponse(detail="User not found", status_code=404)
...
class TestHealthResponse:
    ...
    def test_health_response(self):
        ...
        health = HealthResponse(status="healthy", ai_connected=True, data_loaded=True)
