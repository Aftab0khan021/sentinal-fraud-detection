...
class FraudDetectionProducer:
    ...
    def send_transaction(self, transaction: Dict[str, Any], user_id: Optional[str] = None):
        ...
        try:
            ...
            logger.info(
                f"Transaction sent: partition={record_metadata.partition}, offset={record_metadata.offset}"
            )
...
class FraudDetectionConsumer:
    ...
    def _send_alert(self, user_id: str, transaction: Dict[str, Any], result: Dict[str, Any]):
        ...
        logger.warning(
            f"FRAUD ALERT: User {user_id}, probability={result.get('fraud_probability'):.2f}"
        )
