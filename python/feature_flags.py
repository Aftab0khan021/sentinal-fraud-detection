...
class FeatureFlags:
    ...
    def set_flag(self, flag_name: str, enabled: bool, value: Any = None, 
                 ttl: int = 3600, rollout_percentage: Optional[int] = None):
        """
        Set a feature flag.
...
def is_feature_enabled(flag_name: str, user_id: Optional[str] = None, default: bool = False) -> bool:
    """
